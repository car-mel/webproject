  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        // Query to retrieve announcements ordered by datetime
        $sql = "SELECT announcement_text, announcement_datetime FROM $table ORDER BY announcement_datetime DESC";
        $result = $conn->query($sql);

        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                $announcementText = $row['announcement_text'];
                $announcementDatetime = $row['announcement_datetime'];

                echo "<li>$announcementText <br> Posted on: $announcementDatetime</li>";
            }
        } else {
