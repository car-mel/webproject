          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Activities<span>/January-December</span></h5>

                  <!-- Line Chart -->
                  <!-- Your HTML form and canvas -->
                  <canvas id="barChart" style="max-height: 400px;"></canvas>
<script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
<?php
include_once('../NiceUser/fetch_data.php');
?>
<script>
  document.addEventListener("DOMContentLoaded", () => {
    const chart = new Chart(document.querySelector('#barChart'), {
      ...
      data: {
        ...
        datasets: [{
          label: 'Bar Chart',
          data: [<?=countActivityPerMonth(1)?>, <?=countActivityPerMonth(2)?>, <?=countActivityPerMonth(3)?>, <?=countActivityPerMonth(4)?>, <?=countActivityPerMonth(5)?>, <?=countActivityPerMonth(6)?>, <?=countActivityPerMonth(7)?>, <?=countActivityPerMonth(8)?>, <?=countActivityPerMonth(9)?>, <?=countActivityPerMonth(10)?>, <?=countActivityPerMonth(11)?>, <?=countActivityPerMonth(12)?>], // Initialize with empty data
        ...
        <div class="col-lg-4">
          ...
          <div class="card">
            ...
            <div class="card-body pb-2">
              <h5 class="card-title" style="text-align: center;">Pie Chart of Gender</h5>

              <canvas id="genderPieChart" style="max-height: 400px;"></canvas>
          ...
          <div class="card">
            ...
            <div class="card-body pb-2" style="text-align: center;">
              ...
              <form id="announcementForm" class="container mt-4">
    <div class="form-group">
        <label for="contentInput">Content:</label>
        <textarea id="contentInput" class="form-control" placeholder="Enter your content" required rows="15"></textarea>
    </div>

    <button type="button" class="btn btn-primary" onclick="postAnnouncement()">Post Announcement</button>
</form>
    <script>
