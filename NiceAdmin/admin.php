        ...
        <tbody>
            <?php while ($row = $result->fetch_assoc()) { ?>
                <tr>
                    ...
                    <td>
                        <select class="status-select" data-userid="<?php echo $row['id']; ?>">
...
.catch(error => console.error(error));
          ...
          <div class="card">
            ...
            <div class="card-body pb-0">
              ...
              <form method="POST" action="post_announcement.php" style="text-align:center;">
        <label for="announcement_text">Announcement:</label> <br>
        <textarea id="announcement_text" name="announcement_text" rows="4" cols="50" required></textarea>
        <br>
